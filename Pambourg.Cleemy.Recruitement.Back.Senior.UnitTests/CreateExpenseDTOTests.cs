...
namespace Pambourg.Cleemy.Recruitement.Back.Senior.UnitTests
{
    ...
    {
        [Fact]
        public void ValidateCreateExpenseDTOOk()
        {
            /// Arrange
            ...
            /// Act
            Exception exception = Record.Exception(() => createExpenseDTO.ValidateCreateExpenseDTO());
        ...
        [Fact]
        public void ValidateCreateExpenseDTOKoToOld()
        {
            /// Arrange
            CreateExpenseDTO createExpenseDTO = new CreateExpenseDTO()
            {
            ...
            /// Act, Assert
            Assert.Throws<DateTooOldException>(() => createExpenseDTO.ValidateCreateExpenseDTO());
        }

        [Fact]
        public void ValidateCreateExpenseDTOKoDateInFutur()
        {
            /// Arrange
            CreateExpenseDTO createExpenseDTO = new CreateExpenseDTO()
            {
            ...
            /// Act, Assert
            Assert.Throws<DateInFutureException>(() => createExpenseDTO.ValidateCreateExpenseDTO());
        }

        [Fact]
        public void ValidateCreateExpenseDTOKoNoComment()
        {
            /// Arrange
            CreateExpenseDTO createExpenseDTO = new CreateExpenseDTO()
            {
            ...
            /// Act, Assert
            Assert.Throws<CommentEmptyException>(() => createExpenseDTO.ValidateCreateExpenseDTO());
        }
